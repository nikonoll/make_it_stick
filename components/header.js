...
const Header = ({ deckId }) => (
  <header className="flex items-center justify-between flex-wrap p-3 flex-shrink-0">
      <div className="flex items-center justify-between flex-wrap">
        <div className="flex-0 py-2 px-4 cursor-pointer">
          <Link href="/">
        ...
        <div className="flex-1 px-4 text-xs">daily progress:</div>
        <div className="flex-0 px-4 mt-2">
